...
export const DEFAULT_TASK_TYPES: TaskType[] = withDefaultStateValues([
  ...
  },
  {
    ...
    states: [
      ...
      {
        state: "organize_stake",
        label: "Organize stake",
        color: "#f59e0b",
        state_group: "active",
        assign_to_user_id: null,
      },
      {
        state: "stake_interview",
        label: "Stake interview",
        color: "#f97316",
        state_group: "active",
        assign_to_user_id: null,
      },
  ...
  {
    type: "temple_endowment_living",
    name: "Temple endowment (living)",
    name_short: "TE",
    color: "#7c3aed",
    configuration: { durationMinutes: 30, showTaskTitle: false },
    enabled: true,
    ...
    states: [
      ...
      {
        state: "submit_to_stake",
        label: "Submit to stake",
        color: "#f59e0b",
        state_group: "active",
        assign_to_user_id: null,
      },
      ...
      {
        state: "submitted_to_temple",
        label: "Submitted to temple",
        color: "#a855f7",
        state_group: "active",
        assign_to_user_id: null,
      },
  ...
  {
    type: "temple_sealing_living",
    name: "Temple sealing (living)",
    name_short: "TS",
    color: "#9333ea",
  ...
  {
    type: "patriarchal_blessing_recommend",
    name: "Patriarchal blessing recommend",
    name_short: "PB",
    color: "#0d9488",
    ...
    states: [
      ...
      {
        state: "submit_in_system",
        label: "Submit in system",
        color: "#f59e0b",
        state_group: "active",
        assign_to_user_id: null,
      },
      {
        state: "patriarchal_blessing",
  ...
  },
  {
    ...
    states: [
      ...
      {
        state: "in_front_of_ward",
        label: "In front of ward",
        color: "#06b6d4",
        state_group: "active",
        assign_to_user_id: null,
        sunday_meeting_item_type: "member_welcome",
      },
      {
        state: "record",
        label: "Record in LCR",
  ...
  {
    type: "child_naming_blessing",
    name: "Naming and blessing a child",
    name_short: "NB",
    color: "#db2777",
    configuration: { durationMinutes: 10, showTaskTitle: false },
    enabled: true,
    source: "default",
    states: [
      {
        state: "todo",
        label: "Prepare child record form",
        color: "#3b82f6",
        state_group: "not_started",
        assign_to_user_id: null,
      },
      {
        ...
        state_group: "active",
        assign_to_user_id: null,
        sunday_meeting_item_type: "child_naming_blessing",
      },
      {
        state: "create_membership_record",
        label: "Create membership record",
        color: "#0f766e",
        state_group: "active",
        assign_to_user_id: null,
      },
  ...
  {
    type: "missionary_recommendation",
    name: "Missionary recommendation",
    name_short: "MR",
    color: "#16a34a",
    configuration: { durationMinutes: 45, showTaskTitle: false },
    enabled: true,
    source: "default",
    states: [
      {
      ...
      {
        state: "confirm_submitted_by_stake",
        label: "Confirm submitted by stake",
        color: "#a855f7",
        state_group: "active",
        assign_to_user_id: null,
      },
  ...
  },
  {
    ...
    states: [
      ...
      {
        state: "in_front_of_ward",
        label: "Sustain in front of ward",
        color: "#06b6d4",
        state_group: "active",
        assign_to_user_id: null,
        sunday_meeting_item_type: "calling_sustain",
      },
      {
        state: "set_apart",
        label: "Set apart",
  ...
  },
  {
    ...
    states: [
      ...
      {
        state: "sustain",
        label: "Sustain in front of quorum",
        color: "#7e22ce",
        state_group: "active",
        assign_to_user_id: null,
      },
      ...
      },
      {
        ...
        state_group: "active",
        assign_to_user_id: null,
        sunday_meeting_item_type: "priesthood_aaronic_inform",
      },
      {
        state: "done",
        label: "Done",
  ...
  },
  {
    ...
    states: [
      ...
      {
        state: "sustain",
        label: "Sustain at stake conference",
        color: "#7e22ce",
        state_group: "active",
        assign_to_user_id: null,
      },
      ...
      {
        state: "report",
        label: "Report ordination to stake",
        color: "#0f766e",
        state_group: "active",
        assign_to_user_id: null,
      },
